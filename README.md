...
> Additionally, the program allows changing the material of the sphere. Material files are located in the `pkg/materials` folder, where users can add or modify material properties.
